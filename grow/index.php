				...
				<div class="statsWrap">
					<div class="stats">
						...
						<div class="statInfo">
							...
							<p class="statText">Internet connected devices is the average per household <br>(BDC 2013)</p>
						</div>
					</div>
				</div>
				<div class="statsWrap">
			...
			<div class="col-xs-12 logo">
				...
				<div class="col-xs-12">
					...
					<div id="vbn-quote" class="col-xs-6 col-xs-offset-3">
						"Ms. Laurel Lindsay spoke intelligently, eloquently and enthusiastically to my members. The title of her presentation was “Social in 17 – Successfully Market Yourself on social media in just 17 minutes a day.” Laurel totally engaged the audience with her stories and examples and the depth and breadth of her knowledge around all things social media. She opened many eyes to the potential that can be realized by harnessing the power of social media to build followers leading to sales and ultimately a better business. My members simply loved her."<br><br>
						<em style="float:right"><strong>Roger Killen, Organizer, Vancouver Business Network</strong></em>
					</div>
					<div id="urban-mortgage-quote" class="col-xs-6 col-xs-offset-3">
						"Based on a survey I completed, your session [1 of 8 sessions] Successfully Marketing Your Business Using Social Media got the top rating at 72% for helping my client’s professional development!"<br><br>
						<em style="float:right"><strong>Kimberely Epp, Training Manager, Urban Mortgage</strong></em>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
				...
				<div class="col-sm-4">
					...
					<div class="hr-left"></div>
					<div class="hr-right"></div>
					<p>The web has changed how <br>consumers buy and businesses<br> compete - there is no time <br>like the present to get <br>web marketing working for you.</p>
				</div>
		</div>
	</div>
</section>
				...
				<div class="statsWrap">
					<div class="stats">
						...
						<div class="statInfo">
							...
							<p class="statText" style="margin-top:-50px;">Qualms designing a custom program, just for you. </p>
						</div>
					</div>
				</div>
			</div>
...
<div class="section-grow col-xs-11 col-xs-offset-1 as-seen-on">
	...
	<div class="col-xs-12 col-sm-3">
		<img style="margin:0 auto;" width=97 height=57 class="img-responsive" src="../images/amazon.png" alt="Amazon">
	</div>
</div>
